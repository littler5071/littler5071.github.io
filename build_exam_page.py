...
def mid_section():
    ...
    wrong_html = ""
    try:
        w = json.load(open(MID_JSON, encoding="utf-8"))["wrong"]
        cards = []
        for x in w:
            cards.append(f"""
  <article class="q">
...
<div class="wrap">
  ...
  <div class="summary">
    ...
    <div class="box"><div class="big">2 題</div><div>初級總共只錯這兩題（都在 114 年第四梯次）</div></div>
...
{mid_section()}
  <h2><span class="dot"></span>初級錯的那兩題（這份報告最有價值的部分）</h2>
  {''.join(wrong)}
