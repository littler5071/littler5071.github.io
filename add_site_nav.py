...
NAV_CSS = """  /* hermesnav（共用導覽） */
  ...
  .hnav a.brand{font-size:15.5px;color:#4a4640;text-decoration:none;margin-right:12px;letter-spacing:.04em;
        padding:3px 11px;border-radius:999px;border:1.5px solid transparent}
...
<nav class="hnav">
  ...
  <a class="lnk" href="{base}/#ai">AI 助理實測</a>
...
def inject(path):
    ...
    cat = "stock" if rel.startswith("stock") else ("toeic" if rel.startswith("toeic") else "home")
